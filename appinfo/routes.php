...
return [
    'routes' => [
		...
		['name' => 'downloads#getAria2Status',	'url' => '/api/v2/aria2/status',		'verb' => 'GET'],
		['name' => 'downloads#startAria2',	'url' => '/api/v2/aria2/start',		'verb' => 'POST'],
		['name' => 'downloads#stopAria2',	'url' => '/api/v2/aria2/stop',		'verb' => 'POST'],
		['name' => 'downloads#cancelDownload',	'url' => '/api/v2/downloads/{gid}/cancel',	'verb' => 'POST'],
		['name' => 'downloads#deleteDownload',	'url' => '/api/v2/downloads/{gid}/delete',	'verb' => 'POST'],
		['name' => 'downloads#retryDownload',	'url' => '/api/v2/downloads/{gid}/retry',	'verb' => 'POST'],
		['name' => 'downloads#pauseDownload',	'url' => '/api/v2/downloads/{gid}/pause',	'verb' => 'POST'],
		['name' => 'downloads#resumeDownload',	'url' => '/api/v2/downloads/{gid}/resume',	'verb' => 'POST'],
